 ...
 *  Copyright 2011 Department of Computer Science, University of Minnesota
 * Duluth. All rights reserved.
 *
 ...
 */
namespace sivelab {
//! Class representing a basic 3D vector for use with ray tracers and
//! rasterizers in CS5721
/**
 *
 */
class Vector3D
...
public:
  ...
  //! Constructor for the Vector3D class that sets values to provided x, y, and
  //! z values.
