...
void createImage(GLuint &textureId, float *pixels, const size_t nx, const size_t ny, Camera *cam, Framebuffer (*gen_fb)(size_t, size_t, Camera *));
...
int main(int argc, char *argv[])
{
    ...
    // glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB32F, nx, ny, 0, GL_RGB, GL_FLOAT, pixels);
